...
import KontaktiForm from "@/components/KontaktiForm";

export const metadata: Metadata = {
  title: "Na Kontaktoni",
  description: "Na kontaktoni për çdo pyetje rreth blerjes ose shitjes së makinave në Shqipëri. Jemi këtu çdo ditë të javës.",
  keywords: ["kontakt mjetmarket", "kontakto shitet makina", "ndihmë blerje makine shqiperi"],
};
